...
public class DepotImportation_Muni_REST_JSON:IDepotImportationMunicipalites
{
    ...
    public IEnumerable<MunicipaliteEntite> LireMunicipalites()
    {
        ...
        List<MunicipaliteEntite>? municipalites = null;
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            municipalites = JsonSerializer.Deserialize<List<MunicipaliteEntite>>(jsonContent);
        }
        
        return municipalites;
    }
    
    public IEnumerable<MunicipaliteEntite> Lire(string p_jsonContent)
{
    ...
    return root!.result!.records!.Select(m =>
        new MunicipaliteEntite(
            ...
            m!.mcourriel,
            m!.mweb,
            m!.datelec // Utilisation directe du DateTime? sans conversion
        )
    ).ToList();
}
