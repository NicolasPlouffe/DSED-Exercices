...
namespace M01_DAL_Municipalite_SQLServer
{
    public class DepotMunicipalitesSQLServer : Entite.IDepotMunicipalites
    {
        ...
        public void AjouterMunicipalite(Entite.MunicipaliteEntite municipaliteEntite)
        {
            ...
            {
                this.m_contexte.Municipalite.Add(new MunicipaliteDTO(municipaliteEntite));
        ...
        public void DesactiverMunicipalite(Entite.MunicipaliteEntite municipaliteEntite)
        {
            ...
            MunicipaliteDTO? m = this.m_contexte.Municipalite.Where(m => m.MunicipaliteId == municipaliteEntite.CodeGeographique).SingleOrDefault();
            if (m is null)
            {
        ...
        public void MAJMunicipalite(Entite.MunicipaliteEntite municipaliteEntite)
        {
            ...
            MunicipaliteDTO municipaliteDto = new MunicipaliteDTO(municipaliteEntite);
            this.m_contexte.Municipalite.Update(municipaliteDto);
            this.m_contexte.SaveChanges();
        }
    }
}
